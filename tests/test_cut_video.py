...
from sliceffmpeg.cut_video import parse_time, generate_ffmpeg_command
...
class TestCutVideo(unittest.TestCase):
    ...
    def test_generate_ffmpeg_command(self):
        ...
        self.assertEqual(generate_ffmpeg_command(input_video, time_init, time_final, output_video), expected_command)
